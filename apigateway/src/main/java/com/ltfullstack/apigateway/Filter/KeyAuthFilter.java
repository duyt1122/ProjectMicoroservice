...
public class KeyAuthFilter extends AbstractGatewayFilterFactory<KeyAuthFilter.Config> {
    ...
    public Mono<Void> handleException(ServerWebExchange exchange, String message, HttpStatus status) {
        ...
        String errorResponse = String.format(
                ...
                java.time.ZonedDateTime.now().toString(),status.value(), status.getReasonPhrase(),
